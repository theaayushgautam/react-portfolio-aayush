...
import { SiTableau, SiMicrosoftexcel, SiPython } from "react-icons/si";
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiTableau className="text-7xl text-sky-700" />
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiApacheairflow className="text-7xl text-red-500" />
        </motion.div>
        <motion.div
          variants={iconVariants(4)}
          initial="initial"
